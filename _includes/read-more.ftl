<section class="read-more">
  <#if prePost??>
    <div class="read-more-item">
      ...
      <h2 class="post-list__post-title post-title"><a href="${context!}archives/${prePost.slug}" title="link to ${prePost.title!}">${prePost.title!}</a></h2>
  ...
  <#if nextPost??>
    <div class="read-more-item">
      ...
      <h2 class="post-list__post-title post-title"><a href="${context!}archives/${nextPost.slug}" title="link to ${nextPost.title!}">${nextPost.title!}</a></h2>

    ...
    <div class="panel-main__inner panel-inverted">
      <div class="panel-main__content">
        <a href="${context!}#blog" title="前往 ${options.blog_title!} 的主页" class="blog-button">
          <img src="${user.avatar!}" width="80" alt="${options.blog_title!} logo" class="panel-cover__logo logo" />
        </a>
        <h1 class="panel-cover__title panel-title">
          <a href="${context!}#blog" title="link to homepage for ${options.blog_title!}" class="blog-button">
            ${options.blog_title!}
          </a>
        </h1>
            ...
            <nav class="cover-navigation cover-navigation--primary">
              <ul class="navigation">
                <li class="navigation__item">
                  <a href="${context!}#blog" title="${settings.blog_button_description!}" class="blog-button">
